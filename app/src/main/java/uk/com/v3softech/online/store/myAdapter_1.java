...
public class myAdapter_1 extends FirebaseRecyclerAdapter<product,myAdapter_1.holder> {

Context context;
    public myAdapter_1(@NonNull FirebaseRecyclerOptions<product> options,Context _context) {
        super(options);
